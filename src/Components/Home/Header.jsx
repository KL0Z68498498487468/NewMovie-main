...
function Header() {
  ...
  return (
    ...
    <div className="layer-2 w-full px-4 md:px-8 lg:px-16 xl:px-38 text-center h-screen absolute z-2 bg-gradient-to-t from-[#141414]/70 from-10% via-black/70 to-[#141414] flex items-center justify-center flex-col gap-y-2 backdrop-blur-[1px] md:gap-y-3 lg:gap-y-3.75 pt-16 md:pt-20 lg:pt-25">
