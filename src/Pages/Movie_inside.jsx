...
import { FaPlay, FaPlus, FaStar, FaChevronLeft, FaChevronRight, FaCalendar, FaLanguage, FaFilm, FaArrowUp } from 'react-icons/fa';
    ...
    <div className="info-container max-w-[1400px] mx-auto flex flex-col lg:flex-row gap-8 lg:gap-12">
      ...
      <div className="part-1 w-full lg:w-[850px] flex flex-col gap-6 md:gap-8">
        ...
        <div className="description-section bg-[#1a1a1a] border border-[#262626] rounded-xl p-6 md:p-8 lg:p-10">
          <h2 className=" text-xl text-[#999999] md:text-2xl lg:text-[18px] font-semibold mb-4 md:mb-5">Description</h2>
        ...
        <div className="cast-section bg-[#1a1a1a] border border-[#262626] rounded-xl p-6 md:p-8 lg:p-10">
          <div className="cast-header flex items-center justify-between mb-5 md:mb-6">
            <h2 className="text-white text-xl md:text-2xl lg:text-[28px] font-semibold">Cast</h2>
          ...
          <div className="cast-slider overflow-hidden">
            <div className="cast-track flex gap-4 md:gap-5">
              {[1,2,3,4,5,6,7,8].map((actor) => (
                <div key={actor} className="cast-card flex-shrink-0 w-[100px] md:w-[120px] lg:w-[130px]">
        ...
        <div className="reviews-section bg-[#1a1a1a] border border-[#262626] rounded-xl p-6 md:p-8 lg:p-10">
          <div className="reviews-header flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 md:mb-8">
            <h2 className="text-white text-xl md:text-2xl lg:text-[28px] font-semibold">Reviews</h2>
...
<Swiper className="w-full"
      ...
      >
        ...
        <SwiperSlide><div className="review-card flex-1 bg-[#0f0f0f] border border-[#262626] rounded-xl p-5 md:p-6">
              <div className="review-header flex items-start justify-between mb-4">
                <div className="user-info">
                  <h4 className="text-white text-base md:text-lg font-semibold mb-1">Emily Johnson</h4>
                  <p className="text-[#666] text-xs md:text-sm">From Canada</p>
                </div>
                <div className="rating flex items-center gap-1">
                  {[1,2,3,4,5].map((star) => (
                    <FaStar key={star} className="text-[#e50000] text-sm md:text-base" />
                  ))}
                  <span className="text-white text-sm md:text-base ml-1">5</span>
                </div>
              </div>
        ...
        <SwiperSlide><div className="review-card flex-1 bg-[#0f0f0f] border border-[#262626] rounded-xl p-5 md:p-6">
          ...
          <div className="pagination flex items-center justify-center gap-3">
            <button onClick={() => swiperInst?.slidePrev()} aria-label="Previous" className="shevron-shell-prev w-10 h-10 flex items-center justify-center bg-[#0f0f0f] hover:bg-[#1f1f1f] border border-[#333] rounded-lg transition-colors">
              <FaChevronLeft className="text-white text-sm" />
            </button>
            <button onClick={() => swiperInst?.slideNext()} aria-label="Next" className="shevron-shell-next w-10 h-10 flex items-center justify-center bg-[#0f0f0f] hover:bg-[#1f1f1f] border border-[#333] rounded-lg transition-colors">
      ...
      <div className="part-2 w-full lg:w-[416px] flex flex-col gap-5 md:gap-6">
        ...
        <div className="info-card bg-[#1a1a1a] border border-[#262626] rounded-xl p-5 md:p-6">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="text-[#999] text-sm md:text-base">Released Year</h3>
          </div>
          <p className="text-white text-lg md:text-xl font-semibold">1993-12-15</p>
        </div>
        ...
        <div className="info-card bg-[#1a1a1a] border border-[#262626] rounded-xl p-5 md:p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-[#999] text-sm md:text-base">Available Languages</h3>
          </div>
          <div className="languages flex flex-wrap gap-2.5">
            {["German", "Polish", "Hebrew", "English"].map((lang) => (
              <span key={lang} className="px-4 py-2 bg-[#0f0f0f] border border-[#333] hover:border-[#e50000] rounded-lg text-white text-sm transition-colors cursor-pointer">
                {lang}
              </span>
            ))}
          </div>
          ...
          <div className="ratings-list flex flex-col gap-4">
            <div className="rating-item">
              <div className="flex items-center justify-between mb-2">
                <span className="text-white text-base font-medium">IMDb</span>
                <div className="flex items-center gap-1.5">
                  {[1,2,3,4,5].map((star) => (
                    <FaStar key={star} className="text-[#e50000] text-base" />
                  ))}
                  <span className="text-white font-semibold text-lg ml-1">5</span>
                </div>
              </div>
            </div>
            <div className="rating-item">
              <div className="flex items-center justify-between">
                <span className="text-white text-base font-medium">Streamvibe</span>
                <div className="flex items-center gap-1.5">
                  {[1,2,3,4,5].map((star) => (
                    <FaStar key={star} className="text-[#e50000] text-base" />
                  ))}
        ...
        <div className="info-card bg-[#1a1a1a] border border-[#262626] rounded-xl p-5 md:p-6">
          ...
          <div className="genres flex flex-wrap gap-2.5">
            {["Drama", "History", "War"].map((genre) => (
              <span key={genre} className="px-4 py-2 bg-[#0f0f0f] border border-[#333] hover:border-[#e50000] hover:bg-[#e50000] rounded-lg text-white text-sm transition-colors cursor-pointer">
                {genre}
              </span>
            ))}
          </div>
        ...
        {/* Director */}
        <div className="info-card bg-[#1a1a1a] border border-[#262626] rounded-xl p-5 md:p-6">
          <h3 className="text-[#999] text-sm md:text-base mb-4">Director</h3>
          <div className="director-info flex items-center gap-4">
            ...
            <div>
              <h4 className="text-white text-base md:text-lg font-semibold">Steven Spielberg</h4>
        ...
        {/* Music Composer */}
        <div className="info-card bg-[#1a1a1a] border border-[#262626] rounded-xl p-5 md:p-6">
          <h3 className="text-[#999] text-sm md:text-base mb-4">Original Music Composer</h3>
          <div className="composer-info flex items-center gap-4">
            ...
            <div>
              <h4 className="text-white text-base md:text-lg font-semibold">John Williams</h4>
